    ...
    <main className="min-h-screen flex items-center justify-center pt-14 px-4">
      <div className="glass-card rounded-3xl p-10 max-w-sm w-full text-center space-y-6 animate-fade-up">
        ...
        <div className="space-y-2">
          <h1 className="text-2xl font-bold text-brand-espresso">{t('reservation.successTitle')}</h1>
          <p className="text-sm text-brand-espresso/55 leading-relaxed">{t('reservation.successMessage')}</p>
        </div>
